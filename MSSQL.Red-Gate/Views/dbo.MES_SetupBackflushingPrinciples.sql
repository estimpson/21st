...
,	'Part:  ' + p.part
,	p.name
,	BackflushingPrinciple = coalesce(mpbp.BackflushingPrinciple, mgtbp.BackflushingPrinciple, mplbp.BackflushingPrinciple, mcbp.BackflushingPrinciple, 5)
,	DefaultType =
	case
...
create trigger [dbo].[trMES_SetupBackflushingPrinciples] on [dbo].[MES_SetupBackflushingPrinciples] instead of insert, update, delete
as
declare
	@Result int
