...
[RowCreateDT] [datetime] NULL CONSTRAINT [DF__BlanketPr__RowCr__6F6B4809] DEFAULT (getdate()),
[RowCreateUser] [sys].[sysname] NOT NULL CONSTRAINT [DF__BlanketPr__RowCr__705F6C42] DEFAULT (suser_name())
) ON [PRIMARY]
GO
