...
[Activated] [int] NOT NULL CONSTRAINT [DF__BlanketPr__Activ__76D75FA7] DEFAULT ((0)),
...
[Cleared] [int] NOT NULL CONSTRAINT [DF__BlanketPr__Clear__77CB83E0] DEFAULT ((0)),
[RowID] [int] NOT NULL IDENTITY(1, 1),
[RowCreateDT] [datetime] NULL CONSTRAINT [DF__BlanketPr__RowCr__78BFA819] DEFAULT (getdate()),
[RowCreateUser] [sys].[sysname] NOT NULL CONSTRAINT [DF__BlanketPr__RowCr__79B3CC52] DEFAULT (suser_name())
) ON [PRIMARY]
GO
