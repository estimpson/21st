...
CREATE TRIGGER [dbo].[Insert_VendorMonitor_temp]
ON [dbo].[vendors_temp] FOR INSERT
AS
...
GO
ALTER TABLE [dbo].[vendors_temp] ADD CONSTRAINT [pk_vendors_temp] PRIMARY KEY NONCLUSTERED  ([vendor]) ON [PRIMARY]
GO
