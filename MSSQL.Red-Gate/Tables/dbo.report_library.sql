...
GO
ALTER TABLE [dbo].[report_library] ADD CONSTRAINT [PK__report_library__53633AE1] PRIMARY KEY CLUSTERED  ([name], [report]) ON [PRIMARY]
GO
ALTER TABLE [dbo].[report_library] ADD CONSTRAINT [FK__report_li__repor__54575F1A] FOREIGN KEY ([report]) REFERENCES [dbo].[report_list] ([report])
GO
