...
GO
ALTER TABLE [dbo].[kanban] ADD CONSTRAINT [PK__kanban__41448AA6] PRIMARY KEY CLUSTERED  ([kanban_number], [order_no]) ON [PRIMARY]
GO
ALTER TABLE [dbo].[kanban] ADD CONSTRAINT [FK__kanban__order_no__4238AEDF] FOREIGN KEY ([order_no]) REFERENCES [dbo].[order_header] ([order_no])
GO
