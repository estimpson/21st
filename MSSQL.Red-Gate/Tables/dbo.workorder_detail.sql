...
GO
ALTER TABLE [dbo].[workorder_detail] ADD CONSTRAINT [PK__workorder_detail__52593CB8] PRIMARY KEY CLUSTERED  ([workorder], [part]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [idx_workorder_detail_1] ON [dbo].[workorder_detail] ([part], [qty_required], [qty_completed]) ON [PRIMARY]
GO
