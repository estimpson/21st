...
[RowCreateDT] [datetime] NULL CONSTRAINT [DF__location__RowCre__7A53B627] DEFAULT (getdate()),
[RowCreateUser] [sys].[sysname] NULL CONSTRAINT [DF__location__RowCre__7B47DA60] DEFAULT (suser_name()),
[RowModifiedDT] [datetime] NULL CONSTRAINT [DF__location__RowMod__7C3BFE99] DEFAULT (getdate()),
[RowModifiedUser] [sys].[sysname] NULL CONSTRAINT [DF__location__RowMod__7D3022D2] DEFAULT (suser_name())
) ON [PRIMARY]
GO
