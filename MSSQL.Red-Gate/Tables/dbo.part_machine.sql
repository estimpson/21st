...
GO
ALTER TABLE [dbo].[part_machine] ADD CONSTRAINT [PK__part_machine__257C74A0] PRIMARY KEY CLUSTERED  ([part], [machine]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [ix_part_machine_2] ON [dbo].[part_machine] ([machine], [part], [sequence]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [ix_part_machine_1] ON [dbo].[part_machine] ([part], [machine], [sequence]) ON [PRIMARY]
GO
