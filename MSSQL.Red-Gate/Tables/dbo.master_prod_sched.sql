...
GO
ALTER TABLE [dbo].[master_prod_sched] ADD CONSTRAINT [PK__master_prod_sche__1DFB4E69] PRIMARY KEY CLUSTERED  ([ai_row]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [mps_due] ON [dbo].[master_prod_sched] ([due]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [idx_master_prod_sched_1] ON [dbo].[master_prod_sched] ([part], [due], [qnty]) ON [PRIMARY]
GO
