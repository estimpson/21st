CREATE TABLE [dbo].[t4_definition_basis]
(
...
GO
ALTER TABLE [dbo].[t4_definition_basis] ADD CONSTRAINT [pk_t4_definition_basis] PRIMARY KEY CLUSTERED  ([calendar_year], [t4_box], [document], [document_type], [payer]) ON [PRIMARY]
GO
