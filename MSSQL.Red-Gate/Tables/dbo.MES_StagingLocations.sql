...
GO
ALTER TABLE [dbo].[MES_StagingLocations] ADD CONSTRAINT [FK__MES_Stagi__Stagi__34DF7F18] FOREIGN KEY ([StagingLocationCode]) REFERENCES [dbo].[location] ([code]) ON DELETE CASCADE ON UPDATE CASCADE
GO
ALTER TABLE [dbo].[MES_StagingLocations] ADD CONSTRAINT [FK__MES_Stagi__Machi__35D3A351] FOREIGN KEY ([MachineCode]) REFERENCES [dbo].[machine] ([machine_no]) ON DELETE CASCADE ON UPDATE CASCADE
GO
ALTER TABLE [dbo].[MES_StagingLocations] ADD CONSTRAINT [FK__MES_Stagi__PartC__36C7C78A] FOREIGN KEY ([PartCode]) REFERENCES [dbo].[part] ([part]) ON DELETE CASCADE ON UPDATE CASCADE
GO
