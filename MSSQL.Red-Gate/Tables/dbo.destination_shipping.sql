...
[IsAETCRequired] [tinyint] NULL
) ON [PRIMARY]
GO
ALTER TABLE [dbo].[destination_shipping] ADD CONSTRAINT [PK__destination_shipp__1F0EA2DC] PRIMARY KEY CLUSTERED  ([destination]) ON [PRIMARY]
GO
