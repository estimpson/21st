...
GO
ALTER TABLE [dbo].[machine_serial_comm] ADD CONSTRAINT [PK__machine_serial_c__4420F751] PRIMARY KEY CLUSTERED  ([machine]) ON [PRIMARY]
GO
ALTER TABLE [dbo].[machine_serial_comm] ADD CONSTRAINT [FK__machine_s__machi__45151B8A] FOREIGN KEY ([machine]) REFERENCES [dbo].[machine] ([machine_no])
GO
