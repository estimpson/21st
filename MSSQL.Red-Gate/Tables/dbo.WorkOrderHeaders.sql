...
(
[WorkOrderNumber] [varchar] (50) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL CONSTRAINT [DF__WorkOrder__WorkO__46F3425B] DEFAULT ((0)),
[Status] [int] NOT NULL CONSTRAINT [DF__WorkOrder__Statu__47E76694] DEFAULT ((0)),
[Type] [int] NOT NULL CONSTRAINT [DF__WorkOrderH__Type__48DB8ACD] DEFAULT ((0)),
...
[Sequence] [int] NULL,
[DueDT] [datetime] NULL,
[ScheduledSetupHours] [numeric] (20, 6) NOT NULL CONSTRAINT [DF__WorkOrder__Sched__49CFAF06] DEFAULT ((0)),
[ScheduledStartDT] [datetime] NULL,
[ScheduledEndDT] [datetime] NULL,
[RowID] [int] NOT NULL IDENTITY(1, 1),
[RowCreateDT] [datetime] NULL CONSTRAINT [DF__WorkOrder__RowCr__4AC3D33F] DEFAULT (getdate()),
[RowCreateUser] [sys].[sysname] NOT NULL CONSTRAINT [DF__WorkOrder__RowCr__4BB7F778] DEFAULT (suser_name()),
[RowModifiedDT] [datetime] NULL CONSTRAINT [DF__WorkOrder__RowMo__4CAC1BB1] DEFAULT (getdate()),
[RowModifiedUser] [sys].[sysname] NOT NULL CONSTRAINT [DF__WorkOrder__RowMo__4DA03FEA] DEFAULT (suser_name())
) ON [PRIMARY]
GO
...
GO
ALTER TABLE [dbo].[WorkOrderHeaders] ADD CONSTRAINT [PK__WorkOrderHeaders__450AF9E9] PRIMARY KEY CLUSTERED  ([RowID]) ON [PRIMARY]
GO
ALTER TABLE [dbo].[WorkOrderHeaders] ADD CONSTRAINT [UQ__WorkOrderHeaders__45FF1E22] UNIQUE NONCLUSTERED  ([WorkOrderNumber]) ON [PRIMARY]
GO
