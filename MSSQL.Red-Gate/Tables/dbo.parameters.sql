...
[requisition] [char] (1) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
...
GO
ALTER TABLE [dbo].[parameters] ADD CONSTRAINT [PK__parameters__5E9FE363] PRIMARY KEY CLUSTERED  ([company_name]) ON [PRIMARY]
GO
