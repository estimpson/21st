...
GO
ALTER TABLE [dbo].[part_revision] ADD CONSTRAINT [PK__part_revision__4ACDF4E0] PRIMARY KEY CLUSTERED  ([part], [revision], [engineering_level]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [idx_part_revision_eff_dt] ON [dbo].[part_revision] ([effective_datetime]) ON [PRIMARY]
GO
ALTER TABLE [dbo].[part_revision] ADD CONSTRAINT [FK__part_revis__part__4BC21919] FOREIGN KEY ([part]) REFERENCES [dbo].[part] ([part])
GO
