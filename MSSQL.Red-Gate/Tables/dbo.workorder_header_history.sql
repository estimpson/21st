...
GO
ALTER TABLE [dbo].[workorder_header_history] ADD CONSTRAINT [PK__workorder_header__591C1437] PRIMARY KEY CLUSTERED  ([work_order], [machine_no], [sequence]) ON [PRIMARY]
GO
ALTER TABLE [dbo].[workorder_header_history] ADD CONSTRAINT [FK__workorder__proce__5A103870] FOREIGN KEY ([process_id]) REFERENCES [dbo].[process] ([id])
GO
