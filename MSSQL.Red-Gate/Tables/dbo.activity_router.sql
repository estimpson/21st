...
GO
ALTER TABLE [dbo].[activity_router] ADD CONSTRAINT [PK__activity_router__7BA63665] PRIMARY KEY CLUSTERED  ([parent_part], [sequence]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [ix_activity_router_1] ON [dbo].[activity_router] ([parent_part], [part]) ON [PRIMARY]
GO
