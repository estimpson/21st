...
CREATE FUNCTION [EDI4010].[CurrentPlanningReleases]
()
...
--- <Body>
	...
	FROM
		...
		JOIN EDI4010.PlanningHeaders ph
			...
			WHERE ph.RowCreateDT>= COALESCE(DATEADD(dd, COALESCE(bo.PlanningReleaseHorizonDaysBack,-30), GETDATE()), getdate()-30)
