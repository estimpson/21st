...
update
	o
set
	std_quantity = case when std_quantity + @DeltaQty >= 0 then std_quantity + @DeltaQty else 0 end
,	quantity = dbo.udf_GetQtyFromStdQty(o.part, case when std_quantity + @DeltaQty >= 0 then std_quantity + @DeltaQty else 0 end, o.unit_measure)
,	weight = dbo.udf_GetPartNetWeight(o.part, case when std_quantity + @DeltaQty >= 0 then std_quantity + @DeltaQty else 0 end)
from
	dbo.object o
where
	serial = @Serial
