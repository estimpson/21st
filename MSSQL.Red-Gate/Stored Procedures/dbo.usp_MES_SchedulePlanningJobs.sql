...
--- <Body>
--	Do this to try and fix error clicking refresh planning button from floor PCs.
set	@HorizonEndDT = null
...
set	@HorizonEndDT = coalesce(@HorizonEndDT, getdate() + 42)
