...
/****** Object:  Stored Procedure dbo.msp_super_cop_new    Script Date: 4/25/2001 11:11:13 AM ******/

/****** Object:  Stored Procedure dbo.msp_super_cop_new    Script Date: 3/15/2000 3:48:55 PM ******/
create procedure	[dbo].[msp_super_cop_new] (
	@regen_all	char (1),
	@order_no	numeric (8,0) = null,
	@row_id		integer = null )
as
-------------------------------------------------------------------------------------------------------------------------------
--	msp_super_cop_new : 	this procedure calls the explode demand procedure
--
