...
Create procedure [EDI4010].[usp_Stage_2]
...
execute
	...
	@objname = N'EDI4010.StagingShipScheduleHeaders'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDI4010.StagingShipScheduleSupplemental'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDI4010.StagingShipScheduleAccums'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDI4010.StagingShipScheduleAuthAccums'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDI4010.StagingShipSchedules'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDI4010.StagingPlanningHeaders'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDI4010.StagingPlanningSupplemental'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDI4010.StagingPlanningAccums'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDI4010.StagingPlanningAuthAccums'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDI4010.StagingPlanningReleases'
...
--- <Insert rows="*">
set	@TableName = 'EDI4010.ShipScheduleHeaders'

insert
	EDI4010.ShipScheduleHeaders
(	RawDocumentGUID
,	DocumentImportDT
,	TradingPartner
,	DocType
...
,	sfh.DocumentDT
from
	EDI4010.StagingShipScheduleHeadersT sfh
...
--- <Insert rows="*">
set	@TableName = 'EDI4010.ShipScheduleSupplemental'

insert
	EDI4010.ShipScheduleSupplemental
(		[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
from
	EDI4010.StagingshipScheduleSupplementalT 
...
--- <Insert rows="*">
set	@TableName = 'EDI4010.ShipScheduleAccums'

insert
	EDI4010.ShipScheduleAccums
(		[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
from
	EDI4010.StagingshipScheduleAccumsT sfr
...
--- <Insert rows="*">
set	@TableName = 'EDI4010.ShipScheduleAuthAccums'

insert
	EDI4010.ShipScheduleAuthAccums
(	[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
from
	EDI4010.StagingShipScheduleAuthAccumsT sfr
...
--- <Insert rows="*">
set	@TableName = 'EDI4010.ShipSchedules'

insert
	EDI4010.ShipSchedules
(		[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
select
      ...
      ,[ReleaseDT]
from
	EDI4010.StagingShipSchedulesT sfr
...
--- <Insert rows="*">
set	@TableName = 'EDI4010.PlanningHeaders'

insert
	EDI4010.PlanningHeaders
(	RawDocumentGUID
,	DocumentImportDT
,	TradingPartner
,	DocType
...
,	sfh.DocumentDT
from
	EDI4010.StagingPlanningHeadersT sfh
...
--- <Insert rows="*">
set	@TableName = 'EDI4010.PlanningSupplemental'

insert
	EDI4010.PlanningSupplemental
(	[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
from
	EDI4010.StagingPlanningSupplementalT 
...
--- <Insert rows="*">
set	@TableName = 'EDI4010.PlanningAccums'

insert
	EDI4010.PlanningAccums
(	[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
from
	EDI4010.StagingPlanningAccumsT sfr
...
--- <Insert rows="*">
set	@TableName = 'EDI4010.PlanningAuthAccums'

insert
	EDI4010.PlanningAuthAccums
(	[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
from
	EDI4010.StagingPlanningAuthAccumsT 
...
--- <Insert rows="*">
set	@TableName = 'EDI4010.PlanningReleases'

insert
	EDI4010.PlanningReleases
(	[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
select
      ...
      ,[DateDT]
from
	EDI4010.StagingPlanningReleasesT sfr
...
truncate table
	EDI4010.StagingShipScheduleHeadersT
truncate table
	EDI4010.StagingShipScheduleSupplementalT
truncate table
	EDI4010.StagingShipScheduleAccumsT
truncate table
	EDI4010.StagingShipScheduleAuthAccumsT
truncate table
	EDI4010.StagingShipSchedulesT
truncate table
	EDI4010.StagingPlanningHeadersT
truncate table
	EDI4010.StagingPlanningSupplementalT
truncate table
	EDI4010.StagingPlanningAccumsT
truncate table
	EDI4010.StagingPlanningAuthAccumsT
truncate table
	EDI4010.StagingPlanningReleasesT
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDI4010.StagingShipScheduleHeadersT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDI4010.StagingShipScheduleSupplementalT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDI4010.StagingShipScheduleAccumsT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDI4010.StagingShipScheduleAuthAccumsT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDI4010.StagingShipSchedulesT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDI4010.StagingPlanningHeadersT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDI4010.StagingPlanningSupplementalT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDI4010.StagingPlanningAccumsT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDI4010.StagingPlanningAuthAccumsT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDI4010.StagingPlanningReleasesT'
...
execute
	@ProcReturn = EDI4010.usp_Stage_2
	@TranDT = @TranDT out
...
select
	*
from
	EDI4010.ShipScheduleHeaders sdhv
...
select
	*
from
	EDI4010.ShipScheduleSupplemental sdrv

Select 'SSAccums'	
select
	*
from
	EDI4010.ShipScheduleAccums sdrv

Select 'SSAuthAccums'
select
	*
from
	EDI4010.ShipScheduleAuthAccums sdrv

Select 'SSchedules'
select
	*
from
	EDI4010.ShipSchedules sdrv
...
select
	*
from
	EDI4010.PlanningHeaders sdhv
Select 'PlanningSupplemental'
select
	*
from
	EDI4010.PlanningSupplemental sdrv
Select 'PlanningAccums'
select
	*
from
	EDI4010.PlanningAccums sdrv

Select 'PlanningAuthAccums'
select
	*
from
	EDI4010.PlanningAuthAccums sdrv

Select 'PlanningReleases'
select
	*
from
	EDI4010.PlanningReleases sdrv
go
