...
/*
Create Table.FIS_Empower_21st.EDI.XMLShipNotice_ASNExceptionHandler.sql
*/

use FIS_Empower_21st
go

--drop table EDI.XMLShipNotice_ASNExceptionHandler
if	objectproperty(object_id('EDI.XMLShipNotice_ASNExceptionHandler'), 'IsTable') is null begin
...
/*
Create trigger EDI.tr_XMLShipNotice_ASNExceptionHandler_uRowModified on EDI.XMLShipNotice_ASNExceptionHandler
*/

--use FIS_Empower_21st
--go

if	objectproperty(object_id('EDI.tr_XMLShipNotice_ASNExceptionHandler_uRowModified'), 'IsTrigger') = 1 begin
	drop trigger EDI.tr_XMLShipNotice_ASNExceptionHandler_uRowModified
end
go
...
select
	*
from
	EDI.XMLShipNotice_ASNExceptionHandler xsnadrf
go
