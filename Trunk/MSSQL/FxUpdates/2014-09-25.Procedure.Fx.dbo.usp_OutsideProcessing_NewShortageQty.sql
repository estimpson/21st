...
/*
Create Procedure.Fx.dbo.usp_OutsideProcessing_NewShortageQty.sql
*/

--use Fx
--go

if	objectproperty(object_id('dbo.usp_OutsideProcessing_NewShortageQty'), 'IsProcedure') = 1 begin
	drop procedure dbo.usp_OutsideProcessing_NewShortageQty
end
go
