...
/*
Create View.Fx.dbo.OutsideProcessing_ProcessorParts.sql
*/

--use Fx
--go

--drop table dbo.OutsideProcessing_ProcessorParts
if	objectproperty(object_id('dbo.OutsideProcessing_ProcessorParts'), 'IsView') = 1 begin
	drop view dbo.OutsideProcessing_ProcessorParts
end
go
