...
/*
Create Procedure.Fx.dbo.usp_InventoryControl_UpdatePartOnHand.sql
*/

--use Fx
--go

if	objectproperty(object_id('dbo.usp_InventoryControl_UpdatePartOnHand'), 'IsProcedure') = 1 begin
	drop procedure dbo.usp_InventoryControl_UpdatePartOnHand
end
go
