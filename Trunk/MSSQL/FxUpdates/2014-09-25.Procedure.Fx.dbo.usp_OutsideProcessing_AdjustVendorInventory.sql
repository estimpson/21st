...
/*
Create Procedure.Fx.dbo.usp_OutsideProcessing_AdjustVendorInventory.sql
*/

--use Fx
--go

if	objectproperty(object_id('dbo.usp_OutsideProcessing_AdjustVendorInventory'), 'IsProcedure') = 1 begin
	drop procedure dbo.usp_OutsideProcessing_AdjustVendorInventory
end
go
