...
/*
Create Procedure.Fx.dbo.usp_Purchasing_AddReceipt.sql
*/

--use Fx
--go

if	objectproperty(object_id('dbo.usp_Purchasing_AddReceipt'), 'IsProcedure') = 1 begin
	drop procedure dbo.usp_Purchasing_AddReceipt
end
go
