...
/*
Create Procedure.Fx.dbo.usp_ReceivingDock_ReceiveObject_Inventory.sql
*/

--use Fx
--go

if	objectproperty(object_id('dbo.usp_ReceivingDock_ReceiveObject_Inventory'), 'IsProcedure') = 1 begin
	drop procedure dbo.usp_ReceivingDock_ReceiveObject_Inventory
end
go
