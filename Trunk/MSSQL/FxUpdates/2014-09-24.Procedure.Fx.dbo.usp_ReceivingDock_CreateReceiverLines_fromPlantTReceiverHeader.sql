...
/*
Create Procedure.Fx.dbo.usp_ReceivingDock_CreateReceiverLines_fromPlantTReceiverHeader.sql
*/

--use Fx
--go

if	objectproperty(object_id('dbo.usp_ReceivingDock_CreateReceiverLines_fromPlantTReceiverHeader'), 'IsProcedure') = 1 begin
	drop procedure dbo.usp_ReceivingDock_CreateReceiverLines_fromPlantTReceiverHeader
end
go
