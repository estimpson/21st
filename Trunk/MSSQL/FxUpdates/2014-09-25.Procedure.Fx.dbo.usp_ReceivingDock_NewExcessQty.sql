...
/*
Create Procedure.Fx.dbo.usp_ReceivingDock_NewExcessQty.sql
*/

--use Fx
--go

if	objectproperty(object_id('dbo.usp_ReceivingDock_NewExcessQty'), 'IsProcedure') = 1 begin
	drop procedure dbo.usp_ReceivingDock_NewExcessQty
end
go

create procedure dbo.usp_ReceivingDock_NewExcessQty
	@Operator varchar(5)
