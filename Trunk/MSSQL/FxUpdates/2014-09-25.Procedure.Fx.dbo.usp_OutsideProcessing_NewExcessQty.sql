...
/*
Create Procedure.Fx.dbo.usp_OutsideProcessing_NewExcessQty.sql
*/

--use Fx
--go

if	objectproperty(object_id('dbo.usp_OutsideProcessing_NewExcessQty'), 'IsProcedure') = 1 begin
	drop procedure dbo.usp_OutsideProcessing_NewExcessQty
end
go
