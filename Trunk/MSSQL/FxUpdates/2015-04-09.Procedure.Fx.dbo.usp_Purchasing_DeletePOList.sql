...
/*
Create Procedure.Fx.dbo.usp_Purchasing_DeletePOList.sql
*/

--use Fx
--go

if	objectproperty(object_id('dbo.usp_Purchasing_DeletePOList'), 'IsProcedure') = 1 begin
	drop procedure dbo.usp_Purchasing_DeletePOList
end
go
