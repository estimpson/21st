...
/*
Create Procedure.Fx.dbo.usp_ReceivingDock_PutAwaySerial.sql
*/

--use Fx
--go

if	objectproperty(object_id('dbo.usp_ReceivingDock_PutAwaySerial'), 'IsProcedure') = 1 begin
	drop procedure dbo.usp_ReceivingDock_PutAwaySerial
end
go
