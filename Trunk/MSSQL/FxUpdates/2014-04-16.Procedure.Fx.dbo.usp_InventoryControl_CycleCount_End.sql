...
/*
Create Procedure.Fx.dbo.usp_InventoryControl_CycleCount_End.sql
*/

--use Fx
--go

if	objectproperty(object_id('dbo.usp_InventoryControl_CycleCount_End'), 'IsProcedure') = 1 begin
	drop procedure dbo.usp_InventoryControl_CycleCount_End
end
go
