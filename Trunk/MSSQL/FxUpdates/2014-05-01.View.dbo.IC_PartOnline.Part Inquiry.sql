...
/*
Create View.FxArmada.dbo.IC_PartOnline.sql
*/

--use FxArmada
--go

--drop table dbo.IC_PartOnline
if	objectproperty(object_id('dbo.IC_PartOnline'), 'IsView') = 1 begin
	drop view dbo.IC_PartOnline
end
go
