...
/*
Create Procedure.Fx.dbo.usp_ReceivingDock_ReceiveRMAObjects.sql
*/

--use Fx
--go

if	objectproperty(object_id('dbo.usp_ReceivingDock_ReceiveRMAObjects'), 'IsProcedure') = 1 begin
	drop procedure dbo.usp_ReceivingDock_ReceiveRMAObjects
end
go
