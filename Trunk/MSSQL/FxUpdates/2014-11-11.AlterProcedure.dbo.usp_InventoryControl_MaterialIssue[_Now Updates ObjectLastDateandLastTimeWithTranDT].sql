...
/****** Object:  StoredProcedure [dbo].[usp_InventoryControl_MaterialIssue]    Script Date: 11/11/2014 10:18:17 AM ******/
SET ANSI_NULLS ON
GO
...
ALTER procedure [dbo].[usp_InventoryControl_MaterialIssue]
	@Operator varchar(5)
,	@Serial int
