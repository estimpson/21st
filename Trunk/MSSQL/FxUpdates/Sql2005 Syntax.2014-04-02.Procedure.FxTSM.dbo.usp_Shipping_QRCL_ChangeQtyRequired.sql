...
/*
Create Procedure.FxTSM.dbo.usp_Shipping_QRCL_ChangeQtyRequired.sql
*/

--use FxTSM
--go

if	objectproperty(object_id('dbo.usp_Shipping_QRCL_ChangeQtyRequired'), 'IsProcedure') = 1 begin
	drop procedure dbo.usp_Shipping_QRCL_ChangeQtyRequired
end
go
...
--- <SP Begin Logging>
declare
	@tranCountEntry int; set @tranCountEntry = @@TRANCOUNT
