...
/****** Object:  StoredProcedure [dbo].[usp_ReceivingDock_CreateReceiverLines_fromReceiverHeader]    Script Date: 4/30/2014 11:42:07 AM ******/
SET ANSI_NULLS ON
GO
...
ALTER PROCEDURE [dbo].[usp_ReceivingDock_CreateReceiverLines_fromReceiverHeader]
(	@ReceiverID INT,
	@Result INT OUTPUT)
AS
