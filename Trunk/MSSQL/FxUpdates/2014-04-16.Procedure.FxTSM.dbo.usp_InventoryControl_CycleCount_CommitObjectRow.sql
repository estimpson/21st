...
/*
Create Procedure.FxTSM.dbo.usp_InventoryControl_CycleCount_CommitObjectRow.sql
*/

--use FxTSM
--go

if	objectproperty(object_id('dbo.usp_InventoryControl_CycleCount_CommitObjectRow'), 'IsProcedure') = 1 begin
	drop procedure dbo.usp_InventoryControl_CycleCount_CommitObjectRow
end
go
