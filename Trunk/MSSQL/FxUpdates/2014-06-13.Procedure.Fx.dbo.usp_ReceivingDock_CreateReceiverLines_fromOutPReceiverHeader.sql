...
/*
Create Procedure.Fx.dbo.usp_ReceivingDock_CreateReceiverLines_fromOutPReceiverHeader.sql
*/

--use Fx
--go

if	objectproperty(object_id('dbo.usp_ReceivingDock_CreateReceiverLines_fromOutPReceiverHeader'), 'IsProcedure') = 1 begin
	drop procedure dbo.usp_ReceivingDock_CreateReceiverLines_fromOutPReceiverHeader
end
go
