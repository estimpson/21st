...
/*
Create Procedure.Fx.dbo.usp_Admin_LoginUser.sql
*/

--use Fx
--go

if	objectproperty(object_id('dbo.usp_Admin_LoginUser'), 'IsProcedure') = 1 begin
	drop procedure dbo.usp_Admin_LoginUser
end
go
