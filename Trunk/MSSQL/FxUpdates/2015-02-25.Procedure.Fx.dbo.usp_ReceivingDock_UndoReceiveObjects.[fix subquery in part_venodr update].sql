...
/*
Create Procedure.Fx.dbo.usp_ReceivingDock_UndoReceiveObjects.sql
*/

--use Fx
--go
exec sp_rename 'dbo.usp_ReceivingDock_UndoReceiveObjects', 'usp_ReceivingDock_UndoReceiveObjects_bk20160829'
go

if	objectproperty(object_id('dbo.usp_ReceivingDock_UndoReceiveObjects'), 'IsProcedure') = 1 begin
	drop procedure dbo.usp_ReceivingDock_UndoReceiveObjects
end
go
