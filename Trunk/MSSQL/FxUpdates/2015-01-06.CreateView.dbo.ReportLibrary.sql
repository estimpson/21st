...
/*
Create View.FxArmada.dbo.ReportLibrary.sql
*/

--use FxArmada
--go

--drop table dbo.ReportLibrary
if	objectproperty(object_id('dbo.ReportLibrary'), 'IsView') = 1 begin
	drop view dbo.ReportLibrary
end
go
...
/*
Create ViewTrigger.Fx.dbo.tr_ReportLibrary_iud.View.dbo.ReportLibrary.sql
*/

--use Fx
--go

if	objectproperty(object_id('dbo.tr_ReportLibrary_iud'), 'IsTrigger') = 1 begin
	drop trigger dbo.tr_ReportLibrary_iud
end
go
