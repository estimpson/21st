...
/*
Create Procedure.FxArmada.dbo.usp_NetMPS_Replace.sql
*/

--use FxArmada
--go

if	objectproperty(object_id('dbo.usp_NetMPS_Replace'), 'IsProcedure') = 1 begin
	drop procedure dbo.usp_NetMPS_Replace
end
go
