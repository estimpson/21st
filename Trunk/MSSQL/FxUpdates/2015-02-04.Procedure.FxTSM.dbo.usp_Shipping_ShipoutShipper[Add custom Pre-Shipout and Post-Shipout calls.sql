...
/*
Create Procedure.FxTSM.dbo.usp_Shipping_ShipoutShipper.sql
*/

--use FxTSM
--go

if	objectproperty(object_id('dbo.usp_Shipping_ShipoutShipper'), 'IsProcedure') = 1 begin
	drop procedure dbo.usp_Shipping_ShipoutShipper
end
go
