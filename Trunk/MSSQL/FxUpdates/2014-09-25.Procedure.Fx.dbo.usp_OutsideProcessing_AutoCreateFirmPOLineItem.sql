...
/*
Create Procedure.Fx.dbo.usp_OutsideProcessing_AutoCreateFirmPOLineItem.sql
*/

--use Fx
--go

if	objectproperty(object_id('dbo.usp_OutsideProcessing_AutoCreateFirmPOLineItem'), 'IsProcedure') = 1 begin
	drop procedure dbo.usp_OutsideProcessing_AutoCreateFirmPOLineItem
end
go
