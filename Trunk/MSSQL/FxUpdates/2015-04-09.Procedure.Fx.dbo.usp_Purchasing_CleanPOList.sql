...
/*
Create Procedure.Fx.dbo.usp_Purchasing_CleanPOList.sql
*/

--use Fx
--go

if	objectproperty(object_id('dbo.usp_Purchasing_CleanPOList'), 'IsProcedure') = 1 begin
	drop procedure dbo.usp_Purchasing_CleanPOList
end
go

create procedure dbo.usp_Purchasing_CleanPOList
	@User varchar(10)
,	@POList varchar(max)
...
execute
	@ProcReturn = dbo.usp_Purchasing_CleanPOList
	@Param1 = @Param1
,	@TranDT = @TranDT out
