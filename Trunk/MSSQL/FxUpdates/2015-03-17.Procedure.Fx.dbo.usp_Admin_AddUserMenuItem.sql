...
/*
Create Procedure.Fx.dbo.usp_Admin_AddUserMenuItem.sql
*/

--use Fx
--go

if	objectproperty(object_id('dbo.usp_Admin_AddUserMenuItem'), 'IsProcedure') = 1 begin
	drop procedure dbo.usp_Admin_AddUserMenuItem
end
go
...
execute
	@ProcReturn = dbo.usp_Admin_AddUserMenuItem
	@Param1 = @Param1
,	@TranDT = @TranDT out
