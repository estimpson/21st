...
/*
Create Procedure.Fx.dbo.usp_ReceivingDock_NewReceiverObjectFromScan.sql
*/

--use Fx
--go

if	objectproperty(object_id('dbo.usp_ReceivingDock_NewReceiverObjectFromScan'), 'IsProcedure') = 1 begin
	drop procedure dbo.usp_ReceivingDock_NewReceiverObjectFromScan
end
go
