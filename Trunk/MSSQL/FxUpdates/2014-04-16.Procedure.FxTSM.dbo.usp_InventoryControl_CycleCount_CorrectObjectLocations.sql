...
/*
Create Procedure.FxTSM.dbo.usp_InventoryControl_CycleCount_CorrectObjectLocations.sql
*/

--use FxTSM
--go

if	objectproperty(object_id('dbo.usp_InventoryControl_CycleCount_CorrectObjectLocations'), 'IsProcedure') = 1 begin
	drop procedure dbo.usp_InventoryControl_CycleCount_CorrectObjectLocations
end
go
