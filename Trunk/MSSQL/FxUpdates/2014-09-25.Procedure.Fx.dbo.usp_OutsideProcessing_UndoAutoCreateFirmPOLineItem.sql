...
/*
Create Procedure.Fx.dbo.usp_OutsideProcessing_UndoAutoCreateFirmPOLineItem.sql
*/

--use Fx
--go

if	objectproperty(object_id('dbo.usp_OutsideProcessing_UndoAutoCreateFirmPOLineItem'), 'IsProcedure') = 1 begin
	drop procedure dbo.usp_OutsideProcessing_UndoAutoCreateFirmPOLineItem
end
go
