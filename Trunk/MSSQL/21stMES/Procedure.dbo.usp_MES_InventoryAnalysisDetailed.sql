...
/*
Create procedure Fx.dbo.usp_MES_InventoryAnalysisDetailed
*/

--use Fx
--go

if	objectproperty(object_id('dbo.usp_MES_InventoryAnalysisDetailed'), 'IsProcedure') = 1 begin
	drop procedure usp_MES_InventoryAnalysisDetailed
end
go

create procedure usp_MES_InventoryAnalysisDetailed
...
exec
	dbo.usp_MES_InventoryAnalysisDetailed
	@PartCode = ?
