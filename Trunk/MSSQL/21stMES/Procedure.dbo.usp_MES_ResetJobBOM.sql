...
/*
Create procedure fx21st.dbo.usp_MES_ResetJobBOM
*/

--use fx21st
--go

if	objectproperty(object_id('dbo.usp_MES_ResetJobBOM'), 'IsProcedure') = 1 begin
	drop procedure dbo.usp_MES_ResetJobBOM
end
go

create procedure dbo.usp_MES_ResetJobBOM
	@JobID int
,	@TranDT datetime out
,	@Result integer out
as
...
--- <Call>	
set	@CallProcName = 'dbo.usp_WorkOrders_ReplaceWODBillOfMaterials'
execute
