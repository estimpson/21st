...
/*
Create procedure Fx.dbo.usp_MES_ReclaimScrapComponent
*/

--use Fx
--go

if	objectproperty(object_id('dbo.usp_MES_ReclaimScrapComponent'), 'IsProcedure') = 1 begin
	drop procedure dbo.usp_MES_ReclaimScrapComponent
end
go
