...
/*
Create procedure Fx.dbo.usp_MES_BOMDiscrepancies
*/

--use Fx
--go

if	objectproperty(object_id('dbo.usp_MES_BOMDiscrepancies'), 'IsProcedure') = 1 begin
	drop procedure dbo.usp_MES_BOMDiscrepancies
end
go
