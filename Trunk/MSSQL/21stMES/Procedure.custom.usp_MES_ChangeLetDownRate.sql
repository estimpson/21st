...
/*
Create procedure fx21st.custom.usp_MES_ChangeLetDownRate
*/

--use fx21st
--go

if	objectproperty(object_id('custom.usp_MES_ChangeLetDownRate'), 'IsProcedure') = 1 begin
	drop procedure custom.usp_MES_ChangeLetDownRate
end
go
