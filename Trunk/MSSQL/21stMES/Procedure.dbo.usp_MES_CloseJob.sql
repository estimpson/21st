...
/*
Create procedure fx21st.dbo.usp_MES_CloseJob
*/

--use fx21st
--go

if	objectproperty(object_id('dbo.usp_MES_CloseJob'), 'IsProcedure') = 1 begin
	drop procedure dbo.usp_MES_CloseJob
end
go

create procedure dbo.usp_MES_CloseJob
	@JobID int
,	@TranDT datetime out
,	@Result integer out
as
...
execute
	@ProcReturn = dbo.usp_MES_CloseJob
	@Param1 = @Param1
,	@TranDT = @TranDT out
