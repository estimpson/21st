...
if	objectproperty(object_id('dbo.fn_MES_GetJobBackflushDetails'), 'IsTableFunction') = 1 begin
	drop function dbo.fn_MES_GetJobBackflushDetails
end
go
		...
		(	select
			...
			where
				...
				join dbo.WorkOrderDetails wod
					...
					and woh.MachineCode = coalesce(lGroupMachines.code, lPlantMachines.code, msl.MachineCode, oAvailable.LocationCode)
				join dbo.machine m
