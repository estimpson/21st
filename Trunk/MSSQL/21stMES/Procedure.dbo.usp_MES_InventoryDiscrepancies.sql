...
/*
Create procedure Fx.dbo.usp_MES_InventoryDiscrepancies
*/

--use Fx
--go

if	objectproperty(object_id('dbo.usp_MES_InventoryDiscrepancies'), 'IsProcedure') = 1 begin
	drop procedure dbo.usp_MES_InventoryDiscrepancies
end
go
...
,	[Qty_Manually_Issued_Deleted] = coalesce(Issued.QtyIssued, 0)
