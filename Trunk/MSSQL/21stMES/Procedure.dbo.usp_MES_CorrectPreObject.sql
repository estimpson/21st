...
/*
Create procedure fx21stPilot.dbo.usp_MES_CorrectPreObject
*/

--use fx21stPilot
--go

if	objectproperty(object_id('dbo.usp_MES_CorrectPreObject'), 'IsProcedure') = 1 begin
	drop procedure dbo.usp_MES_CorrectPreObject
end
go
