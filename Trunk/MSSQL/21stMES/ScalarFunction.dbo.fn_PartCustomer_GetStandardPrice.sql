...
if objectproperty(object_id('fn_PartCustomer_GetStandardPrice'), 'IsScalarFunction') = 1 
	begin
		drop function fn_PartCustomer_GetStandardPrice
	end
go

create function fn_PartCustomer_GetStandardPrice
(	@PartCode varchar(25)
