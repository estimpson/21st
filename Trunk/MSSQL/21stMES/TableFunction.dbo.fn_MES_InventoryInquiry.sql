...
if	objectproperty(object_id('dbo.fn_MES_InventoryInquiry'), 'IsTableFunction') = 1 begin
	drop function dbo.fn_MES_InventoryInquiry
end
go
...
select
	*
from
	dbo.fn_MES_InventoryInquiry(1796892)