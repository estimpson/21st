...
/*
Create procedure Fx.dbo.usp_InventoryControl_CycleCount_NewHeader
*/

--use Fx
--go

if	objectproperty(object_id('dbo.usp_InventoryControl_CycleCount_NewHeader'), 'IsProcedure') = 1 begin
	drop procedure dbo.usp_InventoryControl_CycleCount_NewHeader
end
go
