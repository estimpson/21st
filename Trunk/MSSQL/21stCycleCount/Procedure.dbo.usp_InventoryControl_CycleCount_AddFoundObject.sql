...
/*
Create procedure Fx.dbo.usp_InventoryControl_CycleCount_AddFoundObject
*/

--use Fx
--go

if	objectproperty(object_id('dbo.usp_InventoryControl_CycleCount_AddFoundObject'), 'IsProcedure') = 1 begin
	drop procedure dbo.usp_InventoryControl_CycleCount_AddFoundObject
end
go
