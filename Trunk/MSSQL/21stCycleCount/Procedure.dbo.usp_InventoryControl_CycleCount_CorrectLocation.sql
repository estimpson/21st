...
/*
Create procedure Fx.dbo.usp_InventoryControl_CycleCount_CorrectLocation
*/

--use Fx
--go

if	objectproperty(object_id('dbo.usp_InventoryControl_CycleCount_CorrectLocation'), 'IsProcedure') = 1 begin
	drop procedure dbo.usp_InventoryControl_CycleCount_CorrectLocation
end
go

create procedure dbo.usp_InventoryControl_CycleCount_CorrectLocation
	@User varchar(10)
