...
if	objectproperty(object_id('dbo.usp_InventoryControl_Transfer'), 'IsProcedure') = 1 begin
	drop procedure dbo.usp_InventoryControl_Transfer
end
go

create procedure dbo.usp_InventoryControl_Transfer
	@Operator varchar(5)
,	@Serial int
...
declare
	@TransferATType char(1)
,	@TransferATRemarks varchar(10)

set	@TransferATType = case when @LocationCode = 'LOST' then 'H' else 'T' end
set @TransferATRemarks = 'Transfer'
