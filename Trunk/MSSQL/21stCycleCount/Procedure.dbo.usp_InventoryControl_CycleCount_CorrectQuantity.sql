...
/*
Create procedure Fx.dbo.usp_InventoryControl_CycleCount_CorrectQuantity
*/

--use Fx
--go

if	objectproperty(object_id('dbo.usp_InventoryControl_CycleCount_CorrectQuantity'), 'IsProcedure') = 1 begin
	drop procedure dbo.usp_InventoryControl_CycleCount_CorrectQuantity
end
go

create procedure dbo.usp_InventoryControl_CycleCount_CorrectQuantity
	@User varchar(10)
