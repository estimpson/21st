...
/*
Create procedure Fx.dbo.usp_InventoryControl_CycleCount_RecoverObject
*/

--use Fx
--go

if	objectproperty(object_id('dbo.usp_InventoryControl_CycleCount_RecoverObject'), 'IsProcedure') = 1 begin
	drop procedure dbo.usp_InventoryControl_CycleCount_RecoverObject
end
go

create procedure dbo.usp_InventoryControl_CycleCount_RecoverObject
	@User varchar(10)
