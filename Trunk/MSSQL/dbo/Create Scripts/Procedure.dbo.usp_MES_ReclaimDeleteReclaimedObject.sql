...
/*
Create procedure Fx.dbo.usp_MES_ReclaimDeleteReclaimedObject
*/

--use Fx
--go

if	objectproperty(object_id('dbo.usp_MES_ReclaimDeleteReclaimedObject'), 'IsProcedure') = 1 begin
	drop procedure dbo.usp_MES_ReclaimDeleteReclaimedObject
end
go
