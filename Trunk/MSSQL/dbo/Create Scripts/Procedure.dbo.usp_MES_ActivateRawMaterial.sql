...
/*
Create procedure fx21st.dbo.usp_MES_ActivateRawMaterial.
*/

use fx21st
go

if	objectproperty(object_id('dbo.usp_MES_ActivateRawMaterial'), 'IsProcedure') = 1 begin
	drop procedure dbo.usp_MES_ActivateRawMaterial
end
go
