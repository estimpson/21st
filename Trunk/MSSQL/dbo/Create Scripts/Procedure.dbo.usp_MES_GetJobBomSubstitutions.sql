...
/*
Create procedure fx21st.dbo.usp_MES_GetJobBomSubstitutions
*/

--use fx21st
--go

if	objectproperty(object_id('dbo.usp_MES_GetJobBomSubstitutions'), 'IsProcedure') = 1 begin
	drop procedure dbo.usp_MES_GetJobBomSubstitutions
end
go
