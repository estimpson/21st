...
/*
Create procedure fx21stPilot.dbo.usp_MES_ClosePreObject
...
if	objectproperty(object_id('dbo.usp_MES_ClosePreObject'), 'IsProcedure') = 1 begin
	drop procedure dbo.usp_MES_ClosePreObject
end
go
