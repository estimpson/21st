...
/*
Create view fx21st.dbo.MES_BOMJobSubstitution
*/

--use fx21st
--go

--drop table dbo.MES_BOMJobSubstitution
if	objectproperty(object_id('dbo.MES_BOMJobSubstitution'), 'IsView') = 1 begin
	drop view dbo.MES_BOMJobSubstitution
end
go
