...
/*
Create Procedure.Fx.dbo.usp_Shipping_PartPackaging_VerifyPack.sql
*/
...
,	@PackDisabled = 0-- coalesce(spps.PackDisabled, Defaults.PackDisabled)
,	@PackEnabled = 1 --coalesce(spps.PackEnabled, Defaults.PackEnabled)
,	@PackWarn = 0 --coalesce(spps.PackWarn, Defaults.PackWarn)
from
	(	select
			PackDisabled = 1
		,	PackEnabled = 0
